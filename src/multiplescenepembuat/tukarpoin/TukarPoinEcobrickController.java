package multiplescenepembuat.tukarpoin;
...
public class TukarPoinEcobrickController implements Initializable {
    ...
    private void handleTukarSaldo() {
        ...
        try {
            saldoFile = new FileInputStream("DataSaldo.xml");
    ...
    private void handleTukarPoin() {
        ...
        if (totalPoin >= poinTukar) {
            ...
            try (FileOutputStream fileOutputStream = new FileOutputStream("DataPoin.xml")) {
    ...
    private void simpanSaldoKeXML(List<DataSaldo> dataSaldoList) {
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream("DataSaldo.xml")) {
            fileOutputStream.write(xmlString.getBytes());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        double totalSaldo = 0; // Ubah tipe data menjadi double
        for (DataSaldo saldo : dataSaldoList) {
            totalSaldo += Double.parseDouble(saldo.getSaldo()); // Menggunakan parseDouble untuk mengonversi menjadi
                                                                // double
        }
